...
export const tracks = [
    "../foret_malediction/music/3 Hours of Relaxing Super Nintendo Music, Part 1.1 - SNESdrunk (online-audio-converter.com) (1).mp3",
    "../foret_malediction/music/3 Hours of Relaxing Super Nintendo Music, Part 1.2 - SNESdrunk (online-audio-converter.com) (1).mp3",
    "../foret_malediction/music/3 More Hours of Relaxing Super Nintendo Music 2.1- SNESdrunk (online-audio-converter.com).mp3",
    "../foret_malediction/music/3 More Hours of Relaxing Super Nintendo Music 2.2 - SNESdrunk (online-audio-converter.com).mp3",
    "../foret_malediction/music/Another 3 Hours of Relaxing Super Nintendo Music 3.1 - SNESdrunk (online-audio-converter.com).mp3",
    "../foret_malediction/music/Another 3 Hours of Relaxing Super Nintendo Music 3.2 - SNESdrunk (online-audio-converter.com).mp3",
    "../foret_malediction/music/Good Ending - Relaxing & downbeat Sega Genesis music mix (2 hours) part 1 (online-audio-converter.com).mp3",
    "../foret_malediction/music/Good Ending - Relaxing & downbeat Sega Genesis music mix (2 hours) part 2 (online-audio-converter.com).mp3",
    "../foret_malediction/music/Relaxing GenesisMegadrive Music (100 songs) - Part 1.1 (online-audio-converter.com) (1) - Copie.mp3",
    "../foret_malediction/music/Relaxing GenesisMegadrive Music (100 songs) - Part 1.2 (online-audio-converter.com) (1).mp3",
    "../foret_malediction/music/Relaxing GenesisMegadrive Music (100 songs) - Part 2.1 (online-audio-converter.com) (1).mp3",
    "../foret_malediction/music/Relaxing GenesisMegadrive Music (100 songs) - Part 2.2 - SNESdrunk (online-audio-converter.com) (1) - Copie.mp3",
    "../foret_malediction/music/Relaxing Super Nintendo Music, Part 4.1- SNESdrunk (online-audio-converter.com).mp3",
    "../foret_malediction/music/Relaxing Super Nintendo Music, Part 4.2 - SNESdrunk (online-audio-converter.com).mp3"
];
...
export function playGameOverMusic() {
    try {
        ...
        const gameOverAudio = new Audio('../foret_malediction/music/Orphee - Voyage Aux Enfers - Intro (1985)(Loriciels).mp3');
...
export function playVictoryMusic() {
    try {
        ...
        const victoryAudio = new Audio('../foret_malediction/music/We-Have-to-Struggle-for-our-Future-Against-our-Doubt.mp4');
